  ...
  return (
    <div>
      ...
      <div className="container my-10">
        <div className="pb-10">
          <Header title={"Get in Touch with Estatein"} description={"Welcome to Estatein's Contact Us page. We're here to assist you with any inquiries, requests, or feedback you may have."} showAbstract={false}/>
        </div>
        ...
        <div className="mt-10">
          <Header title={"Let's Connect"} description={"We're excited to connect with you and learn more about your real estate goals. Use the form below to get in touch with Estatein."} showAbstract={true} />
